...
extension Config {
    public struct ZenzaiProfile: StringConfigItem {
        ...
        public static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.ZenzaiProfile"
    }
}
...
extension Config {
    ...
    public struct OpenAiModelName: StringConfigItem {
        ...
        public static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.OpenAiModelName"
    }
    ...
    public struct OpenAiApiEndpoint: StringConfigItem {
        ...
        public static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.OpenAiApiEndpoint"
    ...
    struct PromptHistory: StringConfigItem {
        static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.PromptHistory"
    }
}
