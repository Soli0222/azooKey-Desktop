...
extension Config.Deprecated {
    ...
    struct TypeCommaAndPeriod: BoolConfigItem {
        ...
        static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.typeCommaAndPeriod"
    }
    ...
    struct ZenzaiIntegration: BoolConfigItem {
        ...
        static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.enableZenzai"
    }
    ...
    struct EnableOpenAiApiKey: BoolConfigItem {
        static let `default` = false
        static let key: String = "dev.soli0222.inputmethod.azooKeyMac.preference.enableOpenAiApiKey"
    }
}
