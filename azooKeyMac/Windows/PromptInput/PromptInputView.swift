...
struct PromptInputView: View {
    ...
    private func loadPromptHistory() {
        ...
        if let data = UserDefaults.standard.data(forKey: "dev.soli0222.inputmethod.azooKeyMac.preference.PromptHistory") {
        ...
        let historyString = UserDefaults.standard.string(forKey: "dev.soli0222.inputmethod.azooKeyMac.preference.PromptHistory") ?? ""
    ...
    private func savePinnedHistory() {
        if let data = try? JSONEncoder().encode(promptHistory) {
            UserDefaults.standard.set(data, forKey: "dev.soli0222.inputmethod.azooKeyMac.preference.PromptHistory")
        }
    }
